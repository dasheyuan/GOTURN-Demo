...
build/train3 $VIDEOS_FOLDER_IMAGENET $ANNOTATIONS_FOLDER_IMAGENET $CAFFE_MODEL $TRAIN_PROTO $SOLVER_TEMP $LAMBDA_SHIFT $LAMBDA_SCALE $MIN_SCALE $MAX_SCALE $GPU_ID $RANDOM_SEED 2> $RESULT_DIR/results.txt
